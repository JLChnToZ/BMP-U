...
public class ClassicNoteHandler: NoteHandler {
    ...
    protected override void Initialize() {
        transform.position = centroid + Vector3.right * Mathf.Lerp(clampRangeStart, clampRangeEnd, float.IsNaN(delta) ? 0.5F : delta);
